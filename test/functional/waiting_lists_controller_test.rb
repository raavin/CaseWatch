...
class WaitingListsControllerTest < ActionController::TestCase
  ...
  test "should create waiting_list" do
    assert_difference('WaitingList.count') do
      post :create, waiting_list: { acceptance_date: @waiting_list.acceptance_date, completed_date: @waiting_list.completed_date, referral_date: @waiting_list.referral_date }
    end
  ...
  test "should update waiting_list" do
    put :update, id: @waiting_list, waiting_list: { acceptance_date: @waiting_list.acceptance_date, completed_date: @waiting_list.completed_date, referral_date: @waiting_list.referral_date }
    assert_redirected_to waiting_list_path(assigns(:waiting_list))
  end
